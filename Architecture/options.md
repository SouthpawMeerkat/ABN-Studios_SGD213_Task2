...
errors contained to one script.

###Cons
difficulties with more conplex interactions.
...
More interactive damage system.

###Cons
Not suitable for smaller projects. like class room learning.

Heavily Reliant of reliable Syntax.
...
### Pros
Allows for more interactive Gameplay.

more optimised preformance.

### Cons
Is a more advanced coding option.

Errors can spand many components With a class room this may take to long to bug fix with class time.
